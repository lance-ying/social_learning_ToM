...
goal_probs_conditioned_dict = load(joinpath(@__DIR__, "..", "..", "data", "inference", "inference_data_temp_new.jld2"), "goal")
state_probs_conditioned_dict = load(joinpath(@__DIR__, "..", "..", "data", "inference", "inference_data_temp_new.jld2"), "state")
possible_worlds = load(joinpath(@__DIR__, "..", "..", "data", "inference", "inference_data_temp_new.jld2"), "worlds")
