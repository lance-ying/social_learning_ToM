...
for (map_id, agent_goals) in metadata
    ...
    for scenario in 1:2
        ...
        #--- Check if agent1 even needs blue wizards ---#
        ...
        if !agent1_needs_wizards
            # Agent1 doesn't need blue wizards -> no reason to observe
            println("    Agent1 doesn't need blue wizards -> t=0")
...
# Save results
output_filename = "step_dict_mentalize_exp4_v2.json"
