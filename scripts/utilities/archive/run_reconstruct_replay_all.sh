...
EXP1_MODEL_REPLAY_TRACE="${EXP1_MODEL_REPLAY_TRACE:-model_outputs/experiments/exp1/replay_trace.json}"
EXP1_MENTALIZE_STEPS="${EXP1_MENTALIZE_STEPS:-model_outputs/baselines/exp1/step_dict_social_mentalizing.json}"
EXP1_MENTALIZE_REPLAY_TRACE="${EXP1_MENTALIZE_REPLAY_TRACE:-model_outputs/baselines/exp1/replay_trace_social_mentalizing.json}"
EXP1_NONMENTALIZE_STEPS="${EXP1_NONMENTALIZE_STEPS:-model_outputs/baselines/exp1/step_dict_rational_non_mentalizing.json}"
EXP1_NONMENTALIZE_REPLAY_TRACE="${EXP1_NONMENTALIZE_REPLAY_TRACE:-model_outputs/baselines/exp1/replay_trace_rational_non_mentalizing.json}"
EXP1_NAIVE_STEPS="${EXP1_NAIVE_STEPS:-model_outputs/baselines/exp1/step_dict_naive_observer.json}"
EXP1_NAIVE_REPLAY_TRACE="${EXP1_NAIVE_REPLAY_TRACE:-model_outputs/baselines/exp1/replay_trace_naive_observer.json}"
...
EXP1_INFERENCE="${EXP1_INFERENCE:-inference/inference_data_exp1.jld2}"
...
# Exp2
EXP2_MODEL_STEPS="${EXP2_MODEL_STEPS:-model_outputs/experiments/exp2/steps_dict.json}"
EXP2_MODEL_REPLAY_TRACE="${EXP2_MODEL_REPLAY_TRACE:-model_outputs/experiments/exp2/replay_trace.json}"
EXP2_MENTALIZE_STEPS="${EXP2_MENTALIZE_STEPS:-model_outputs/baselines/exp2/step_dict_social_mentalizing.json}"
EXP2_MENTALIZE_REPLAY_TRACE="${EXP2_MENTALIZE_REPLAY_TRACE:-model_outputs/baselines/exp2/replay_trace_social_mentalizing.json}"
EXP2_NONMENTALIZE_STEPS="${EXP2_NONMENTALIZE_STEPS:-model_outputs/baselines/exp2/step_dict_rational_non_mentalizing.json}"
EXP2_NONMENTALIZE_REPLAY_TRACE="${EXP2_NONMENTALIZE_REPLAY_TRACE:-model_outputs/baselines/exp2/replay_trace_rational_non_mentalizing.json}"
EXP2_NAIVE_STEPS="${EXP2_NAIVE_STEPS:-model_outputs/baselines/exp2/step_dict_naive_observer.json}"
EXP2_NAIVE_REPLAY_TRACE="${EXP2_NAIVE_REPLAY_TRACE:-model_outputs/baselines/exp2/replay_trace_naive_observer.json}"
...
EXP2_INFERENCE="${EXP2_INFERENCE:-inference/inference_data_exp2.jld2}"
...
# Exp3
EXP3_MODEL_STEPS="${EXP3_MODEL_STEPS:-model_outputs/experiments/exp3/steps_dict.json}"
...
EXP3_NAIVE_REPLAY_TRACE="${EXP3_NAIVE_REPLAY_TRACE:-model_outputs/baselines/exp3/replay_trace_naive_observer.json}"
...
EXP3_INFERENCE="${EXP3_INFERENCE:-inference/inference_data_exp3.jld2}"
...
# Exp4
EXP4_MODEL_STEPS="${EXP4_MODEL_STEPS:-model_outputs/experiments/exp4/steps_dict.json}"
