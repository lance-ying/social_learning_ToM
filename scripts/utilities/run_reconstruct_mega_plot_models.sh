...
run_reconstruct exp1 full_model "$EXP1_MODEL_STEPS" "$EXP1_INFERENCE" "$EXP1_PROBLEM_DIR"
run_reconstruct exp1 social_mentalizing "$EXP1_MENTALIZE_STEPS" "$EXP1_INFERENCE" "$EXP1_PROBLEM_DIR"
run_reconstruct exp1 rational_non_mentalizing "$EXP1_NONMENTALIZE_STEPS" "$EXP1_INFERENCE" "$EXP1_PROBLEM_DIR"
run_reconstruct exp1 naive_observer "$EXP1_NAIVE_STEPS" "$EXP1_INFERENCE" "$EXP1_PROBLEM_DIR"

run_reconstruct exp2 full_model "$EXP2_MODEL_STEPS" "$EXP2_INFERENCE" "$EXP2_PROBLEM_DIR"
run_reconstruct exp2 social_mentalizing "$EXP2_MENTALIZE_STEPS" "$EXP2_INFERENCE" "$EXP2_PROBLEM_DIR"
run_reconstruct exp2 rational_non_mentalizing "$EXP2_NONMENTALIZE_STEPS" "$EXP2_INFERENCE" "$EXP2_PROBLEM_DIR"
run_reconstruct exp2 naive_observer "$EXP2_NAIVE_STEPS" "$EXP2_INFERENCE" "$EXP2_PROBLEM_DIR"

run_reconstruct exp3 full_model "$EXP3_MODEL_STEPS" "$EXP3_INFERENCE" "$EXP3_PROBLEM_DIR"
run_reconstruct exp3 social_mentalizing "$EXP3_MENTALIZE_STEPS" "$EXP3_INFERENCE" "$EXP3_PROBLEM_DIR"
run_reconstruct exp3 rational_non_mentalizing "$EXP3_NONMENTALIZE_STEPS" "$EXP3_INFERENCE" "$EXP3_PROBLEM_DIR"
run_reconstruct exp3 naive_observer "$EXP3_NAIVE_STEPS" "$EXP3_INFERENCE" "$EXP3_PROBLEM_DIR"

run_reconstruct exp4 full_model "$EXP4_MODEL_STEPS" "$EXP4_INFERENCE" "$EXP4_PROBLEM_DIR"
run_reconstruct exp4 social_mentalizing "$EXP4_MENTALIZE_STEPS" "$EXP4_INFERENCE" "$EXP4_PROBLEM_DIR"
run_reconstruct exp4 rational_non_mentalizing "$EXP4_NONMENTALIZE_STEPS" "$EXP4_INFERENCE" "$EXP4_PROBLEM_DIR"
run_reconstruct exp4 naive_observer "$EXP4_NAIVE_STEPS" "$EXP4_INFERENCE" "$EXP4_PROBLEM_DIR"
