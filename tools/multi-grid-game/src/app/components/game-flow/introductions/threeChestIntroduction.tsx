...
export const threeChestIntroductionText = [
  ...
  <>
    ...
    The other player is an expert player and has full knowledge of which wizard has the amulet. They will always follow the most efficient path. The other player's level will be given to you in each trial.
    `}
  </>,

  <div className="flex flex-col items-center space-y-4">
    <img src="/icons/gameplay.gif" alt="Gameplay demonstration" className="w-full max-w-2xl rounded-lg border-2 border-gray-300" />
...
export const threeChestComprehensionQuestions = [
  {
    id: 'task',
    question: 'What is the task of this experiment?',
    options: [
      { key: 'option1', text: 'Collect one of the treasure chests' },
      { key: 'option2', text: 'Collect all the treasure chests' },
      { key: 'option3', text: 'Watch and help the other player collect treasure chests' }
    ],
    correctAnswer: 'Collect one of the treasure chests'
  },
  {
    id: 'barrier',
    question: 'The treasure chest is hidden behind a red barrier, what should you do?',
    options: [
      { key: 'option1', text: 'Find a red amulet from the red wizard' },
      { key: 'option2', text: 'Find a red amulet from one of the blue wizards' },
      { key: 'option3', text: 'Try to go through the barrier directly' }
    ],
    correctAnswer: 'Find a red amulet from the red wizard'
  },
  {
    id: 'trials',
    question: 'How many trials are in this experiment?',
    options: [
      { key: 'option1', text: '10 trials' },
      { key: 'option2', text: '15 trials' },
      { key: 'option3', text: '20 trials' }
    ],
    correctAnswer: '10 trials'
  }
];