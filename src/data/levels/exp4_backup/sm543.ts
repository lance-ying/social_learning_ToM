...
`.trim(),
  agentPaths: {
    ...
    3: {
      movements: {
        experienced1: {
          path: ["right", "right", "right", "right", "right", "up", "up", "up", "up", "up", "up", "up", "left", "left", "up", "up", "left", "left", "right", "right", "right", "left", "down", "down", "right", "right", "down", "down", "down", "left", "left", "left", "left", "left"],
          goal: 1,
          type: 'Novice'
        },
        experienced2: {
