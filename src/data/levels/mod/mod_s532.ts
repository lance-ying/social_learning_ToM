  ...
  agentPaths: {
    2: {
      movements: {
        ...
        experienced2: { 
          path: ["up", "up", "up", "left", "left", "left", "right", "right", "right", "right", "right", "left", "left", "down", "down", "down", "left", "left", "down", "down", "down", "down", "down", "down", "right", "right", "right", "right", "right"],
          goal: 2,
          type: 'Novice'
        },
        experienced3: { 
