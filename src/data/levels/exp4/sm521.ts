...
`.trim(),
  agentPaths: {
    ...
    3: {
      movements: {
        experienced1: {
          path: ["right", "right", "left", "up", "up", "right", "right", "left", "up", "up", "right", "right", "left", "up", "up", "right", "right", "left", "left", "left", "left", "left", "left", "left", "up", "up", "up", "down", "down", "right", "right", "right", "right", "right", "right", "down", "down", "down", "down", "down", "down", "left", "left", "left", "left", "left", "left", "left", "left", "down", "down"],
          goal: 2,
          type: 'Novice'
        },
        experienced2: {
