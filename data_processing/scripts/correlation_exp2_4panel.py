...
pairs = {
    'ToM Model':      collect_pairs(steps_dict,            human, identity_transform),
    'Naive':           collect_pairs(baseline_naive,        human, identity_transform),
    'Non-mentalize':   collect_pairs(baseline_nonmentalize, human, identity_transform),
    'Mentalize':       collect_pairs(baseline_mentalize,    human, identity_transform),
}
